...
package object i18n {
  ...
  val translations: Map[(String, String), String] = Map(
    // Commands
    (Commands.ADD_PAYEE.toString, "en") -> "➕ Add",
    (Commands.ADD_PAYEE.toString, "es") -> "➕ Agregar",
    (Commands.ADDRESSLIST.toString, "en") -> "\uD83D\uDCD6 Addressses",
    (Commands.ADDRESSLIST.toString, "es") -> "\uD83D\uDCD6 Direcciones",
    ...
    (Commands.HTLCLIST.toString, "en") -> "⏳ Contracts",
    (Commands.HTLCLIST.toString, "es") -> "⏳ Contratos",
